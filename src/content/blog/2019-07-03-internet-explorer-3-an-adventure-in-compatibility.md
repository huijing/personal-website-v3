...
og_image: /images/posts/ie3-challenge.jpg
...
The point of this experiment was to build a website on a _single codebase_ that still looks decent on any browser. To be fair, “any“ is a pretty tall order, and so is “decent”, so I put out the disclaimer that this experiment would either end up being spectacular, or fail spectacularly.
...
```html
&lt;!--[if !IE]> --> &lt;audio controls class="annoying"> &lt;source src="audio/tetoroika.mp3"
...
_Disclaimer, I did have a Windows 95 VirtualBox instance with IE3 installed, so maybe this isn't really building blind like you do Code in the Dark. Let's call it building with severe myopia._
